...
public class Utlity {
    ...
    public static String vehicle_Table(ArrayList<Vehicle> vehicles){
        ...
        for (Vehicle vehicle: vehicles){
            ...
            table = table + "|" + " ".repeat(2) + vehicle.getCurrent_port().getPid() + " ".repeat(2);
    ...
    public static String container_Table(ArrayList<Container> containers){
        ...
        for (Container container: containers){
            ...
            table = table + "|" + " ".repeat(2) + container.getCurrent_port().getPid() + " ".repeat(2);

            if(container.getCurrent_vehicle() == null){
                table = table + "|" + " ".repeat(5) + "NULL" + " ".repeat(5);
            }
            else{
                table = table + "|" + container.getCurrent_vehicle().getVid() + " ";
            }
    ...
    public static String trip_Table(ArrayList<Trip> trip_list){
        ...
        for (Trip trip: trip_list){
            ...
            table = table + "|" + " ".repeat(2) + trip.getD_port().getPid() + " ".repeat(2);
            table = table + "|" + " ".repeat(2) + trip.getA_port().getPid() + " ".repeat(2);
