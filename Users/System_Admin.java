...
public class System_Admin extends User{
    ...
    public static void addSystemAdmin() throws IOException {
        ...
        FileIOUtil.InputObjectIntoFile(new_user, "system_admin.json");
    ...
    public static Port addPort() throws IOException {
        ...
        while (true){
            ...
            if (!Utlity.yes_Or_no("Port.Port name: " + name + ". " + "Would you like to enter again? (Y or N)" )){
                break;
            }
        }
        ...
        while (true){
            ...
            if (!Utlity.yes_Or_no("Port.Port longtitude: " + degree + " degree " + minute + " minutes " + second + " seconds" + hemisphere + ". " +"Would you like to enter again? (Y or N)" )){
                break;
            }
        }
        ...
        while (true){
            ...
            scanner.nextLine();
            if (!Utlity.yes_Or_no("Port.Port storing capacity: " + storing_capacity + ". " + "Would you like to enter again? (Y or N)")){
                break;
            }
        }
        ...
        while (true){
            ...
            scanner.nextLine();
            if (!Utlity.yes_Or_no("Port.Port landing ability: " + landing_ability + ". " + "Would you like to enter again? (Y or N)")){
                break;
            }
        }
    ...
    public static boolean addVehicle() throws IOException {
        ...
        while (true){
            ...
            name = scanner.nextLine();
            if (!Utlity.yes_Or_no("Vehicle_Classes.Vehicle name: " + name + ". " + "Would you like to enter again? (Y or N)")){
                break;
            }

        }
        while (true){
            System.out.println("Choose 0 for Vehicle_Classes.ship, 1 for basic truck, 2 for reefer truck, 3 for tanker truck");
            type = scanner.nextInt();
            if (type == 0){
                vehicle_type = "Vehicle_Classes.ship";
            }
            else if (type == 1){
            ...
            scanner.nextLine();
            if (!Utlity.yes_Or_no("Vehicle_Classes.Vehicle type: " + vehicle_type + ". " + "Would you like to enter again? (Y-N)")){
                break;
            }
        }
    ...
    public static boolean addContainer() throws IOException {
        ...
        while (true){
            ...
            while (true){
                System.out.println("Choose 0 for Dry Storage, 1 for Open Top, 2 for Open Side, 3 for Refridgerated, 4 for Container_Class.Liquid");
                type = scanner.nextInt();
                if (type >=0 && type <= 4){
                    break;
                }
            ...
            scanner.nextLine();
            if (!Utlity.yes_Or_no("Container_Class.Container type: " + container_type + ". " + "Would you like to enter again? (Y-N)")){
                break;
            }
        }
        ...
        while (true){
            ...
            name = scanner.nextLine();
            if (!Utlity.yes_Or_no("Container_Class.Container name: " + name + ". " + "Would you like to enter again? (Y-N)")){
                break;
            }
        ...
        while (true){
            ...
            scanner.nextLine();
            if (!Utlity.yes_Or_no("Container_Class.Container weight: " + weight + ". " + "Would you like to enter again? (Y-N)")){
                break;
            }
        }
